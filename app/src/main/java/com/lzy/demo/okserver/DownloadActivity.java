...
public class DownloadActivity extends BaseActivity {
    ...
    @BindView(R.id.targetFolder) TextView targetFolder;
    @BindView(R.id.tvCorePoolSize) TextView tvCorePoolSize;
    @BindView(R.id.sbCorePoolSize) SeekBar sbCorePoolSize;
    @BindView(R.id.recyclerView) RecyclerView recyclerView;
    @BindView(R.id.openManager) Button openManager;
